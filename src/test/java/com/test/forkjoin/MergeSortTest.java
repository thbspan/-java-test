...
public class MergeSortTest {
    ...
    public static void main(String[] args) {
        ...
        new MergeSortTest().run(configuration);
    }
    ...
    private static class Range {
        ...
        public Range(int start, int step, int iterations) {
            this.start = start;
            this.step = step;
        ...
        public static Range parse(String[] args, int start) {
            ...
            return new Range(Integer.parseInt(args[start]), Integer.parseInt(args[start + 1]), Integer.parseInt(args[start + 2]));
        }
        ...
        public String toString() {
            return String.valueOf(start) + ' ' + step + ' ' + iterations;
        }
    }
    ...
    private static class Configuration {
        ...
        private final static Configuration DEFAULT_CONFIG = new Configuration(new Range(20000, 20000, 10),
                new Range(2, 2, 10));
